...
const Services = () => {
  ...
  return (
    <>
      <section className="bg-[#5840ba] py-20 px-20 text-white relative">
        {/* Header */}
        ...
        {/* Services Grid */}
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 z-10 relative">
